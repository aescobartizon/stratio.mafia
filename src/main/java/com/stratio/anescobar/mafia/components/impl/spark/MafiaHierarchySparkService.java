package com.stratio.anescobar.mafia.components.impl.spark;
...
@Service
public class MafiaHierarchySparkService extends AbstractGenericService implements MafiaHierarchy {

	@Getter
	private String implementation = "sparkGraphx";
